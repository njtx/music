...
public class Main extends Activity {
	...
	ImageButton play,pause,forward,next,stop,ib_menu,back,ib_mode;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ib_menu=(ImageButton) super.findViewById(R.id.ib_menu);
...
//				public static final String mode_4 = "随机播放";
		...
		ib_mode.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View arg0) {
				...
				AlertDialog dialog = new AlertDialog.Builder(Main.this).setTitle("请选择播放模式")
				        .setSingleChoiceItems(items, 0, new DialogInterface.OnClickListener() {
				            ...
				            public void onClick(DialogInterface dialog, int which) {
				            	...
				            	Toast.makeText(Main.this, "已切换到"+items[which]+"模式", Toast.LENGTH_SHORT).show();
				                dialog.dismiss();
				            }
				        }).create();
				dialog.show();
		...
		ib_menu.setOnClickListener(new OnClickListener() {			
			@Override
			public void onClick(View arg0) {
				Intent intent_menu = new Intent(Main.this,GroupListActivity.class);
	...
	private void audioList() {
	    ...
	    listview.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
					...
					new AlertDialog.Builder(Main.this).setTitle("请选择需要添加到的列表:")   
					.setSingleChoiceItems(items, 0, new DialogInterface.OnClickListener() {   
					 public void onClick(DialogInterface dialog, int item) { 
						    db.insertLocal(audioList.get(position));
